...
{
    /// <summary>
    /// This class can be used to calculate the distanceBox
    /// and bearing between two positions.
    /// </summary>
    /// <remarks>
    /// Author:     Daniel Saidi [daniel.saidi@gmail.com]
    /// Link:       http://www.dotnextra.com
    /// Link:       http://myxaab.wordpress.com/2010/09/02/calculate-distanceBox-bearing-between-geolocation/
    /// </remarks>
    public class PositionHandler : IBearingCalculator, IdistanceBoxCalculator, IRhumbBearingCalculator, IRhumbdistanceBoxCalculator
    {
        ...
        /// </summary>
        public double CalculatedistanceBox(Position position1, Position position2, distanceBoxUnit distanceBoxUnit)
        {
            var R = (distanceBoxUnit == distanceBoxUnit.Miles) ? GeoConstants.EarthRadiusInMiles : GeoConstants.EarthRadiusInKilometers;
            ...
            return Math.Round(distanceBox, 2);
        }
        ...
        /// </summary>
        public double CalculateRhumbdistanceBox(Position position1, Position position2, distanceBoxUnit distanceBoxUnit)
        {
            var R = (distanceBoxUnit == distanceBoxUnit.Miles) ? GeoConstants.EarthRadiusInMiles : GeoConstants.EarthRadiusInKilometers;
            var lat1 = angleConverter.ConvertDegreesToRadians(position1.Latitude);
            var lat2 = angleConverter.ConvertDegreesToRadians(position2.Latitude);
